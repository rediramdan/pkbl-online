                            ...
                            <div class="normal-table-list mg-t-30">
                                ...
                                <div class="col-lg-12 todo-inputbar">
                                    <div class="form-group todo-flex pull-right">
                                        ...
                                        <div class="todo-send">
                                            <button
                                                class="btn-primary btn-md btn-block btn notika-add-todo waves-effect"
                                                type="button" id="todo-btn-submit">Cari</button>
                                        </div>
                                    </div>
                                    <div>
                                    ...
                                    <table class="table table-hover text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('pengajuan.edit', $dt->id_pengajuan_mitra)}}"
                                                        class="btn btn-default"><i class="fa fa-list-alt"></a></i>
                                                </td>
                                                <td>
                                                    <a href="{{route('penilaian', $dt->id)}}"
                                                        class="btn btn-default">Penilaian</a>
                                                </td>
                                                <td></td>
                                                <td>{{$dt->user_id}}</td>
                                            </tr>
